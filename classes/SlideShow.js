...
;(function (root, factory) {
    ...
    var SlideShow = function (data) {
        ...
        var header_height = data.fullBleed || data.ignoreHeader ? 0 : oblio.settings.header_height,
            footer_height = data.fullBleed || data.ignoreFooter ? 0 : oblio.settings.footer_height;
    ...
    */
    ...
    function buildSlideshow (slides) {
        ...
        var slide = '<div class="slide"><div class="backplate_wrapper"><img alt="Slideshow Image" class="backplate" data-thumb="{{backplate.thumb}}" data-mode="{{backplate.mode}}" data-anchor="{{backplate.anchor}}" src="' + oblio.settings.base_url + '{{backplate.img}}"></div></div>',
            slides_html = '';
    ...
    function resize (width, height) {
        ...
        if (w === undefined || h === undefined) {
            if (this.elements.resizeContainer) {
                ...
                h = oblio.settings.window_dimensions.height - (this.settings.header_height + this.settings.footer_height);
            }
        }
